        ...
        return (
            <div className="auth-container">
                ...
                <div className="auth-button-container">
                    <Button clicked={this.submitHandler} btnStyle="blue">Submit </Button>
                    <Button clicked={this.switchAuthModeHandler} btnStyle="mint">Switch to {this.state.isSignUp ? 'Sign in' : 'Sign up'} </Button></div>
            </div>
        )
    }
}
